...
\thesistitle{Predicción de ventas con técnicas de machine learning aplicadas a series temporales de contrataciones}
\author{Juan Pablo Skobalski}
\posgrado{Carrera de Especialización en Inteligencia Artificial}
\keywords{Inteligencia Artificial, Pronóstico de ventas, Series temporales, CRM}
...
En este trabajo se desarrolló un modelo de aprendizaje automático junto con un flujo de procesamiento de datos reproducible. El objetivo de este sistema es proyectar las contrataciones de una empresa a partir de fotografías semanales históricas de su sistema de gestión comercial.
\linebreak
En el trabajo se aplicaron de manera integrada contenidos de la Especialización, entre ellos el análisis y la preparación de datos, el aprendizaje automático, las series temporales y la evaluación de modelos.
\end{abstract}
