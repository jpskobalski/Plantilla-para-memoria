...
\begin{titlepage}
    ...
    \begin{flushright}
        ...
        \vspace*{5cm} % Ajustar según la posición vertical deseada

        % Título
        {\fontfamily{phv}\bfseries\fontsize{33pt}{40pt}\selectfont
        Predicción de ventas con técnicas de machine learning aplicadas a series temporales de contrataciones} \\[1.5cm]

        % Autor
        {\fontfamily{phv}\fontsize{20pt}{25pt}\selectfont
        Mg. Juan Pablo Skobalski} \\[1cm]
...
%        \textbf{Carrera de Especialización en Sistemas Embebidos}
        ...
        \textbf{Director:} Mg. Juan Cruz Skobalski} \\[1cm]
        ...
        Ciudad de Buenos Aires, diciembre de 2026} % Ejemplo: Ciudad de Córdoba, junio de 2025
    \end{flushright}
\end{titlepage}
